...
return [
    'title' => env('MOONSHINE_TITLE', 'Admin Panel'),
    'logo' => '/images/logo-white.svg',
    'logo_small' => '/images/logo-white.svg',

    'favicons' => [
        'apple-touch' => '/images/favicon/apple-touch-icon.png',
        '32' => '/images/favicon/favicon-32x32.png',
        '16' => '/images/favicon/favicon-16x16.png',
        'safari-pinned-tab' => '/images/logo-white.svg',
    ],
