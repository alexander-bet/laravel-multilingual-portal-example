...
class MetaTagsServiceProvider extends ServiceProvider
{
    ...
    {
        PackageManager::create('leaflet', function (PackageInterface $package) {
            $package
                ->addStyle('leaflet.css', asset('vendor/leaflet/leaflet.css'))
                ->addScript('leaflet.js', asset('vendor/leaflet/leaflet.js'));
        });
    }
